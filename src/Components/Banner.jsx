...
const Banner = () => {
  return (
    <div  className="bg-gradient-to-r from-green-400 to-green-800 p-8 text-center text-white flex flex-col justify-center items-center">
      ...
      <div className="display flex items-center justify-center gap-20 mt-8 bg-green-100 text-black px-15 py-5 w-full ">
        <FeatCards image={hospital} title="50+ Hospitals"/>
        <FeatCards image={clients} title="2500+ Happy Clients"/>
        <FeatCards image={doctors} title="50+ Hospitals"/>
        <FeatCards image={savings} title="50+ Hospitals"/>
        <FeatCards image={location} title="50+ Hospitals"/>
      </div>
    </div>
  );
};
